...
CMAKE_HELPERS_REF="f79a0e6acdae261270391253d24f47efb54e9a7d"
CMAKE_CPPGIR_REF="47cf94f83b54cda59018135601e19d7fb0c77776"

CODEGEN_REF="ccaf5477295cffe810a220b402028613b9d0d39f"
LIB_BASE_REF="82d182a275e197fd717fecc86193d9d91f4fc5b5"
LIB_CRL_REF="7a165302fed408c84b2d1c2513e35a21a141da44"
LIB_ICU_REF="7e55ddbcda78145b1fdb55c1f07f39299fa263f6"
LIB_LOTTIE_REF="49d67cf66d3573cd71a3228af47a4ac59b64fc90"
LIB_QR_REF="6fdf60461444ba150e13ac36009c0ffce72c4c83"
LIB_RPL_REF="c57cccffb01d85570decd7fccb88419c9a682e63"
LIB_SPELLCHECK_REF="1f18c1e35b99697fe58d48d7f5a88e96c928128e"
LIB_STORAGE_REF="ccdc72548a5065b5991b4e06e610d76bc4f6023e"
LIB_TL_REF="7573852f2fb6ffad152092c71b15437162227147"
LIB_TRANSLATE_REF="09c10726220e6862ca91d39b5dec5119aa0177bc"
LIB_UI_REF="ec0c178bd2aa2acab3c0ca001f18cf9ac8ab89a2"
LIB_WEBRTC_REF="52636e86eaa493de670daf71959d000b281bd153"
LIB_WEBVIEW_REF="71c948902bfac5b25e90e1c9d1c8a34d1ee275c0"

RLOTTIE_REF="8c69fc20cf2e150db304311f1233a4b55a8892d7"
LIBPRISMA_REF="23b0d70f9709da9b38561d5706891a134d18df76"
TGCALLS_REF="2faee3b5524f54d56c91c2058c00e11c656a74b3"
XDG_DESKTOP_PORTAL_REF="23a76c392170dbbd26230f85ef56c3a57e52b857"
MICROTEX_REF="7059649a44c24b640c831adef1e5f5b86e77299f"
...
https://github.com/AyuGram/codegen/archive/${CODEGEN_REF}.tar.gz -> Telegram-codegen-${CODEGEN_REF}.tar.gz
...
https://github.com/desktop-app/lib_translate/archive/${LIB_TRANSLATE_REF}.tar.gz -> Telegram-lib_translate-${LIB_TRANSLATE_REF}.tar.gz
...
https://github.com/desktop-app/MicroTeX/archive/${MICROTEX_REF}.tar.gz -> Telegram-ThirdParty-MicroTeX-${MICROTEX_REF}.tar.gz
"
S="${WORKDIR}/${MY_P}"
...
PATCHES=(
	"${FILESDIR}"/tdesktop-7.0.9-qt6-no-wayland.patch
	...
	"${FILESDIR}"/ayugram-7.0.9-codegen-ayu-lang-subsets.patch
)
...
src_prepare() {
	...
	cp -r "${WORKDIR}/lib_translate-${LIB_TRANSLATE_REF}" "${S}/Telegram/lib_translate" || die
	...
	cp -r "${WORKDIR}/MicroTeX-${MICROTEX_REF}" "${S}/Telegram/ThirdParty/MicroTeX" || die
	...
	# cmark-gfm uses find_library with .cmake suffix to find cmake config files,
	# which conflicts with the blanket find_library REQUIRED sed. Remove the
	# find_library and include lines so the pkg_check_modules fallback (from
	# the cmark-gfm patch) is used instead.
	sed -e '/find_library(DESKTOP_APP_CMARK_GFM/d' \
		-e '/include.*DESKTOP_APP_CMARK_GFM/d' \
		-i cmake/external/cmark_gfm/CMakeLists.txt || die
	...
	rm -f cmake/external/glib/cppgir/expected-lite/example/CMakeLists.txt
	rm -f cmake/external/glib/cppgir/expected-lite/test/CMakeLists.txt
	rm -f cmake/external/glib/cppgir/expected-lite/CMakeLists.txt
}
